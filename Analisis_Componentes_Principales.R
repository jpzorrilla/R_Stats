data(iris)
dim(iris) #revision caracteristicas base de datos
...
#Siempre evaluar que los test hacen lo que dicen 
...
#Observese que la varianza se mantiene en las variables originales y la transformada. El ACP no modifica la estructura de los datos, es una simple rotacion.
...
#TODO LO ANTERIOR SE HACE EN UNAS POCAS LINEA DE CODIGO EN R
Res.pca<-princomp(Xc)
...
#Hay que ser cuidadosos con la escala de los ejes.
biplot(Res.pca)
